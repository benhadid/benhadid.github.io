...
Consultez le << Makefile >> inclus dans ce TP et essayez de répondre aux questions suivantes (Google est votre ami pour apprendre plus sur les Makefiles et répondre à certaines de ces questions).
